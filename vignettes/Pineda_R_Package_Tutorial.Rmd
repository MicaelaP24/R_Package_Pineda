...
download.file("https://raw.githubusercontent.com/MicaelaP24/R_Package_Pineda/master/data/B212_2.csv", destfile = "/cloud/project/data/B212_2")
...
```{r}
noctules <- read.csv("./data/Nyctalus2.csv")
...
```{r}
B212_2 <- read.csv("C:\\Users\\12093\\Documents\\Bat data\\Batday_dataframes\\B212_2.csv")
